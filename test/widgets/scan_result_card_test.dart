...
void main() {
  group('ScanResultCard', () {
    ...
    testWidgets('should display "Latest result" for latest result', (WidgetTester tester) async {
      // Act
    ...
    testWidgets('should display "Scan result" for non-latest result', (WidgetTester tester) async {
      // Act
    ...
    testWidgets('should have copy and share buttons', (WidgetTester tester) async {
      // Act
      await tester.pumpWidget(createWidget());
    ...
    testWidgets('should call onCopy when copy button is pressed', (WidgetTester tester) async {
      // Arrange
      await tester.pumpWidget(createWidget());
    ...
    testWidgets('should call onShare when share button is pressed', (WidgetTester tester) async {
      // Arrange
      await tester.pumpWidget(createWidget());
    ...
    testWidgets('should display timestamp for non-latest result', (WidgetTester tester) async {
      // Act
      await tester.pumpWidget(createWidget(isLatest: false));
    ...
    testWidgets('should not display timestamp for latest result', (WidgetTester tester) async {
      // Act
      await tester.pumpWidget(createWidget(isLatest: true));
    ...
    testWidgets('should have higher elevation for latest result', (WidgetTester tester) async {
      // Arrange
      await tester.pumpWidget(createWidget(isLatest: true));
    ...
    testWidgets('should have lower elevation for non-latest result', (WidgetTester tester) async {
      // Arrange
      await tester.pumpWidget(createWidget(isLatest: false));
      final card = tester.widget<Card>(find.byType(Card));
