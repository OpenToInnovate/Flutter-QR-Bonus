...
void main() {
  group('ScanWindowOverlay', () {
    ...
    testWidgets('should create overlay with scan window',
    ...
    testWidgets('should create border container with correct dimensions',
        (WidgetTester tester) async {
      // Act
      await tester.pumpWidget(createWidget());
    ...
    testWidgets('should have ignore pointer on overlay and border',
        (WidgetTester tester) async {
      // Act
      await tester.pumpWidget(createWidget());
    ...
    testWidgets('should create stack with correct fit',
        (WidgetTester tester) async {
      // Act
      await tester.pumpWidget(createWidget());
